...
import com.google.wanka_a_d_s.MainActivity;
...
public class SplashActivity extends Activity {
    ...
    static final String APP_ID = "179";   // 广告id

    private static final boolean ASK_BANNER_AD = true;
    static final String UMENG_KEY = "58d9ced2717c192339002f54";
    ...
    private static boolean splash_showed = false;
    ...
    private void init(){
        ...
        HjAdManager.init(this,DoMain.app_id);
...
//
//    }
    static final String SPLASH_ID = "1992";//"1992";   // 广告id
...
//        HjSplashAd hjSplashAd = new HjSplashAd(SplashActivity.this, null, SPLASH_ID);
        HjAdManager.showSplashAd(this, null, DoMain.splash_id, new HjAdListener() {
            @Override
